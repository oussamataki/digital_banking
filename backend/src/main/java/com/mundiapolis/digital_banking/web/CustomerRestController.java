...
public class CustomerRestController {
    ...
    public AppUserDto saveUser(@RequestBody AppUserDto appUserDto) {
        System.out.println("heeere"+appUserDto.username);
        AppUser p = new AppUser();
        p.setPassword(appUserDto.password);
        p.setRoles(appUserDto.roleNames);
        p.setUsername(appUserDto.username);
        p.setEmail(appUserDto.email);
